...
from .ui.windows import BuildingInspector, BuildingTab, InventoryWindow, RocketWindow, EndGameWindow, CodeWindow
    ...
    def handle_game_events(self, event):
        ...
        if self.ui_manager.active_window:
            ...
            if res == "CLOSE":
                ...
                self.state = STATE_TITLE
                self.title_screen.state = "MAIN" # Explicitly reset title screen to main menu
            ...
            if self.hud.build_icon_rect.collidepoint(event.pos):
                ...
                if building:
                    if building.type == "Rocket Ship":
                        ...
                        self.ui_manager.open_window(BuildingInspector(building, self.resource_manager, self.world))
